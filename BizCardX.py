...
icon = Image.open(r"D:\DS\Capstone projects\images\bizcard.jpg")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Divya Palapati",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Divya Palapati*!"""})
...
if selected == "Home":
    ...
    with col2:
        st.header(":green[**BizCardX :**] Extracting Business Card Data with OCR")
        st.image(r"D:\DS\Capstone projects\images\bizcard.jpg")
